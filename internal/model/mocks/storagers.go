...
// Source: internal/model/interfaces.go
//
// Generated by this command:
//
//	mockgen -source=internal/model/interfaces.go -destination=internal/model/mocks/storagers.go -package=mocks DBConn
//
...
import (
	...
	model "github.com/soltanat/go-diploma-1/internal/model"
	entities "github.com/soltanat/go-diploma-1/internal/model/entities"
...
// GetTx mocks base method.
func (m *MockOrderStorager) GetTx(ctx context.Context, tx model.Tx, number entities.OrderNumber) (*entities.Order, error) {
	m.ctrl.T.Helper()
...
func (m *MockOrderStorager) Tx(ctx context.Context) model.Tx {
	m.ctrl.T.Helper()
...
func (m *MockOrderStorager) UpdateTx(ctx context.Context, tx model.Tx, order *entities.Order) error {
	m.ctrl.T.Helper()
...
// GetTx mocks base method.
func (m *MockUserStorager) GetTx(ctx context.Context, tx model.Tx, login entities.Login, password *string) (*entities.User, error) {
	m.ctrl.T.Helper()
...
// Tx mocks base method.
func (m *MockUserStorager) Tx(ctx context.Context) model.Tx {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Tx", ctx)
	ret0, _ := ret[0].(model.Tx)
	return ret0
...
// UpdateTx mocks base method.
func (m *MockUserStorager) UpdateTx(ctx context.Context, tx model.Tx, user *entities.User) error {
	m.ctrl.T.Helper()
...
func (m *MockWithdrawalStorager) SaveTx(ctx context.Context, tx model.Tx, withdraw *entities.Withdrawal) error {
	m.ctrl.T.Helper()
...
// Tx mocks base method.
func (m *MockWithdrawalStorager) Tx(ctx context.Context) model.Tx {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Tx", ctx)
	ret0, _ := ret[0].(model.Tx)
	return ret0
